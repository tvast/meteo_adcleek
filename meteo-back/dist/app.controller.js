...
let CitiesController = class CitiesController {
    ...
    async getByInsee(insee) {
        const city = await this.citiesService.findOne(insee);
        if (!city) {
            throw new common_1.NotFoundException(`City with INSEE code ${insee} not found.`);
        }
        return city;
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CitiesController.prototype, "getByInsee", null);
exports.CitiesController = CitiesController = __decorate([
    (0, common_1.Controller)('cities'),
    __metadata("design:paramtypes", [app_service_1.CitiesService])
], CitiesController);
